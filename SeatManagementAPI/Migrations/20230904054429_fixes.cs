    ...
    public partial class fixes : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"CREATE OR ALTER VIEW UnAllocatedView AS
                                    SELECT DISTINCT C.CityAbbreviation, B.BuildingAbbreviation, F.FacilityFloor, F.FacilityName, S.SeatCode , S.SeatId
                                    FROM Facilities F    
                                    JOIN Cities C                                                    
            ...
            migrationBuilder.Sql(@"CREATE OR ALTER VIEW Overview AS
                                    SELECT C.CityAbbreviation, B.BuildingAbbreviation, F.FacilityFloor, F.FacilityName, S.SeatCode,S.SeatId, E.EmployeeName 
                                    FROM Facilities F    
                                    JOIN Cities C                                                    
                                    ON F.CityId = C.CityId                                                      
                                    JOIN Buildings B                                                     
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"DROP VIEW UnAllocatedView;");
        }
    }
}
